...
<body class="primary-bg-color" data-phone-cc-input="{$phoneNumberInputStyle}">
    ...
    <header id="header" class="header">
        ...
        <div class="navbar navbar-light">
            <div class="container">
                <a class="navbar-brand mr-3" href="https://shrotihost.in/">
                    <img src="{$WEB_ROOT}/templates/shrotihost/img/logo.svg" alt="{$companyname}" class="logo-img">
                </a>
                {* Site navigation — mirrors shrotihost.in so the portal feels like one product *}
                <ul class="sh-sitenav d-none d-lg-flex">
                    <li><a href="https://shrotihost.in/hosting">Hosting</a></li>
                    <li><a href="https://shrotihost.in/domains">Domains</a></li>
                    <li><a href="https://shrotihost.in/web-development">Build</a></li>
                ...
                <ul class="navbar-nav toolbar">
                    <li class="nav-item ml-3 d-none d-md-block">
                        {if $loggedin}
                            <a class="btn sh-btn-primary" href="{$WEB_ROOT}/clientarea.php">Dashboard</a>
                        {else}
                            <a class="btn sh-btn-ghost mr-2" href="{$WEB_ROOT}/login.php">Login</a>
                            <a class="btn sh-btn-primary" href="{$WEB_ROOT}/index.php/store/shared-hosting">Get Started</a>
                        {/if}
                    </li>
